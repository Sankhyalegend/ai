...
def load_knowledge_base(file_path: str):
    ...
    :param file_path: The path to the  file containing the knowledge base.
...
def chatbot():
    ...
    knowledge_base: dict = load_knowledge_base('knowledge_base.jsan')
    ...
    while True:
        ...
        if best_match:
            ...
            if new_answer.lower() != 'skip':
                ...
                save_knowledge_base('knowledge_base.jsan', knowledge_base)
